...
const Generate = () => {
  ...
  return (
    <div className='bg-[#E9C0E9] min-h-screen  grid grid-cols-2'>
      ...
      <div className="mt-30 col1 flex justify-center items-center flex-col text-gray-900">
        <div className='flex flex-col gap-5 my-8'>
          ...
          <div className="item">
            ...
            <div className='mx-4'>
              <input value={handle || ""} onChange={e=>{sethandle(e.target.value)}} className='px-4 py-2 my-2 focus:outline-pink-500 bg-white rounded-full'
      ...
      <div className="col2 w-full mt-20  h-screen bg-[#E9C0E9]">
